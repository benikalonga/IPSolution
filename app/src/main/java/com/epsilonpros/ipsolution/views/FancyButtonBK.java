...
public class FancyButtonBK  extends LinearLayout{

    public static final String TAG = FancyButtonBK.class.getSimpleName();
     ...
     */
    public FancyButtonBK(Context context){
        super(context);
     ...
     */
    public FancyButtonBK(Context context, AttributeSet attrs){
        super(context, attrs);
        this.mContext = context;

        TypedArray attrsArray 	= context.obtainStyledAttributes(attrs,R.styleable.FancyButtonBK, 0, 0);
    ...
    private void initAttributesArray(TypedArray attrsArray){
        ...
        mDefaultBackgroundColor 		= attrsArray.getColor(R.styleable.FancyButtonBK_fb_defaultColor,mDefaultBackgroundColor);
        mFocusBackgroundColor 			= attrsArray.getColor(R.styleable.FancyButtonBK_fb_focusColor,mFocusBackgroundColor);
        mDisabledBackgroundColor        = attrsArray.getColor(R.styleable.FancyButtonBK_fb_disabledColor, mDisabledBackgroundColor);

        mEnabled                        = attrsArray.getBoolean(R.styleable.FancyButtonBK_android_enabled, true);

        mDisabledTextColor              = attrsArray.getColor(R.styleable.FancyButtonBK_fb_disabledTextColor, mDisabledTextColor);
        mDisabledBorderColor            = attrsArray.getColor(R.styleable.FancyButtonBK_fb_disabledBorderColor, mDisabledBorderColor);
        mDefaultTextColor 				= attrsArray.getColor(R.styleable.FancyButtonBK_fb_textColor,mDefaultTextColor);
        // if default color is set then the icon's color is the same (the default for icon's color)
        mDefaultIconColor               = attrsArray.getColor(R.styleable.FancyButtonBK_fb_iconColor,mDefaultTextColor);

        mDefaultTextSize                = (int) attrsArray.getDimension(R.styleable.FancyButtonBK_fb_textSize, mDefaultTextSize);
        mDefaultTextSize                = (int) attrsArray.getDimension(R.styleable.FancyButtonBK_android_textSize, mDefaultTextSize);

        mDefaultTextGravity             = attrsArray.getInt(R.styleable.FancyButtonBK_fb_textGravity, mDefaultTextGravity);

        mBorderColor 					= attrsArray.getColor(R.styleable.FancyButtonBK_fb_borderColor, mBorderColor);
        mBorderWidth					= (int) attrsArray.getDimension(R.styleable.FancyButtonBK_fb_borderWidth,mBorderWidth);

        mRadius 						= (int)attrsArray.getDimension(R.styleable.FancyButtonBK_fb_radius,mRadius);

        mRadiusTopLeft                  = (int) attrsArray.getDimension(R.styleable.FancyButtonBK_fb_radiusTopLeft, mRadius);
        mRadiusTopRight                 = (int) attrsArray.getDimension(R.styleable.FancyButtonBK_fb_radiusTopRight, mRadius);
        mRadiusBottomLeft               = (int) attrsArray.getDimension(R.styleable.FancyButtonBK_fb_radiusBottomLeft, mRadius);
        mRadiusBottomRight              = (int) attrsArray.getDimension(R.styleable.FancyButtonBK_fb_radiusBottomRight, mRadius);

        mFontIconSize 					= (int)attrsArray.getDimension(R.styleable.FancyButtonBK_fb_fontIconSize, mFontIconSize);

        mIconPaddingLeft                = (int)attrsArray.getDimension(R.styleable.FancyButtonBK_fb_iconPaddingLeft,mIconPaddingLeft);
        mIconPaddingRight               = (int)attrsArray.getDimension(R.styleable.FancyButtonBK_fb_iconPaddingRight,mIconPaddingRight);
        mIconPaddingTop                 = (int)attrsArray.getDimension(R.styleable.FancyButtonBK_fb_iconPaddingTop,mIconPaddingTop);
        mIconPaddingBottom              = (int)attrsArray.getDimension(R.styleable.FancyButtonBK_fb_iconPaddingBottom,mIconPaddingBottom);

        mTextAllCaps                    = attrsArray.getBoolean(R.styleable.FancyButtonBK_fb_textAllCaps, false);
        mTextAllCaps                    = attrsArray.getBoolean(R.styleable.FancyButtonBK_android_textAllCaps, false);

        mGhost                          = attrsArray.getBoolean(R.styleable.FancyButtonBK_fb_ghost, mGhost);
        mUseSystemFont                  = attrsArray.getBoolean(R.styleable.FancyButtonBK_fb_useSystemFont, mUseSystemFont);

        String text = attrsArray.getString(R.styleable.FancyButtonBK_fb_text);

        if (text == null) { //no fb_text attribute
            text = attrsArray.getString(R.styleable.FancyButtonBK_android_text);
        }

        mIconPosition 					= attrsArray.getInt(R.styleable.FancyButtonBK_fb_iconPosition,mIconPosition);

        String fontIcon 				= attrsArray.getString(R.styleable.FancyButtonBK_fb_fontIconResource);

        String iconFontFamily 			= attrsArray.getString(R.styleable.FancyButtonBK_fb_iconFont);
        String textFontFamily 			= attrsArray.getString(R.styleable.FancyButtonBK_fb_textFont);

        Drawable icon = null;
        try{
            mIconResource 				= attrsArray.getDrawable(R.styleable.FancyButtonBK_fb_iconResource);
        ...
        if(!isInEditMode()){
            if(iconFontFamily!=null){
                mIconTypeFace = findFont(mContext, iconFontFamily, mDefaultIconFont);
            }else{
                mIconTypeFace = findFont(mContext, mDefaultIconFont, null);
            }

            if(textFontFamily!=null){
                mTextTypeFace = findFont(mContext, textFontFamily, mDefaultTextFont);
            }else{
                mTextTypeFace = findFont(mContext, mDefaultTextFont, null);
            }
        }
    ...
    /**
     * Set Icon Position
     * Use the global variables (FancyButtonBK.POSITION_LEFT, FancyButtonBK.POSITION_RIGHT, FancyButtonBK.POSITION_TOP, FancyButtonBK.POSITION_BOTTOM)
    ...
    /**
     * Return TextView Object of the FancyButtonBK
    ...
    /**
     * Return Icon Font of the FancyButtonBK
     * @return TextView Object
     */
    ...
    /**
     * Return Icon of the FancyButtonBK
    ...
    public static Typeface findFont(Context context, String fontPath, String defaultFontPath){
        ...
        if (cachedFontMap.containsKey(fontName)){
            ...
            try{
                ...
                Log.e(FancyButtonBK.TAG, String.format("Unable to find %s font. Using Typeface.DEFAULT instead.", fontName));
